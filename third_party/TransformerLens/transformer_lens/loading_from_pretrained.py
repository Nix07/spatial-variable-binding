...
MODEL_ALIASES = {
    ...
    "Qwen/Qwen2-VL-2B-Instruct": ["qwen2-2b-vl-instruct", "qwen2-vl-2b-instruct"],
...
def convert_hf_model_config(model_name: str, **kwargs):
    ...
    elif "pixtral-12b" in official_model_name: # for hf community model, llava-wrapped 
        cfg_dict = {
            "d_model": 5120,
            "d_head": 4096
            // 32,  # 4096 is the hidden size of the head dim (unified across heads, which is DIFFERENT from the d_model)
            ...
            "act_fn": "silu",
            "use_attn_scale": True,
            "initializer_range": hf_config.vision_config.initializer_range,
            "normalization_type": "RMS",
            "positional_embedding_type": "rotary",
            "rotary_base": hf_config.vision_config.rope_theta,
            "rotary_adjacent_pairs": False,
            "rotary_dim": 4096 // 32,
            "final_rms": True,
            "gated_mlp": True,
...
def get_pretrained_model_config(
    ...
    **kwargs,
    ...
    cfg_dict["device_list"] = device_list
